var adonisPlaylist, currentPlaylistId, adonisPlayer = {},
    adonisAllPlaylists = [],
...
jQuery(document).ready(function (a) {
    ...
    //     title: "Intentions",
    //     artist: "Justin Bieber{#link7}",
    //     mp3: "./frontend/js/mp3/Justin Bieber - Intentions (Official Video (Short Version)) ft. Quavo ( 256kbps cbr ).mp3",
    //     poster: "./frontend/js/mp3/browse/playlist-3.jpg"
    // },
    //     {
    //         title: "Counting Stars",
    //         artist: "One Republic{#link6}",
    //         mp3: "./frontend/js/mp3/OneRepublic - Counting Stars (Official Music Video) ( 256kbps cbr ).mp3",
    //         poster: "./frontend/js/mp3/browse/browse-overview-4.jpg"
    //     },
    // ],
