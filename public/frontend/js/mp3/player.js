    ...
    (adonisPlayer.init = function () {
        ...
        (adonisPlaylist = new adonisJPlayerPlaylist(
            ...
            a("#" + adonisPlayerID).bind(a.jPlayer.event.loadeddata, function (e) {
                ...
                a("#" + adonisPlayerContainer + " .current-item .song-poster img").attr("src", s),
                    a("#" + adonisPlayerID)
                        .find("img")
                        .attr("alt", "");
            }),
            ...
            a("#" + adonisPlayerID).bind(a.jPlayer.event.play + ".jp-repeat", function (e) {
                ...
                r.name ? a("#" + adonisPlayerContainer + " .artist-name").html('<a href="' + r.link + '">' + r.name + "</a>") : a("#" + adonisPlayerContainer + " .artist-name").html(r.name),
                    void 0 !== currentPlaylistId && a("[data-album-id='" + currentPlaylistId + "']").addClass("jp-playing");
            }),
        ...
        function r(t, e) {
            var s = e,
                r = (a("#" + adonisPlayerID).jPlayer.duration, (100 * (t - s.offset().left)) / s.width());
        ...
        a(document).on("click", ".remove-track-item-playlist", function () {
            ...
            (adonisPlayer.addTrack = function (a) {
                ...
                return (
                    ...
                    !1 === s && (adonisPlaylist.add(e), (t = adonisPlaylist.playlist.length - 1)),
                    t
                );
            }),
            ...
            a(document).on("click", ".adonis-album-button", function (t) {
                ...
                e && void 0 !== adonisAllPlaylists[e] && currentPlaylistId !== e && (adonisPlaylist.setPlaylist(adonisAllPlaylists[e]), (currentPlaylistId = e)),
