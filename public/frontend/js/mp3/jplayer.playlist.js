    ...
    (adonisJPlayerPlaylist = function (t, e, i) {
        ...
        (adonisJPlayerPlaylist.prototype = {
            ...
            _createListItem: function (t) {
                ...
                (r += '<div class="img-box music-img-box song-poster"><img src="' + t.poster + '" alt=""><div class="hover-state"><span class="play-btn-dark"><i class="flaticon-play-button"></i></span></div></div>'),
                    (r +=
                ...
                return void 0 === t
                    ...
                    : !this.removing &&
                          (0 <= (t = t < 0 ? e.original.length + t : t) &&
                              ...
                              ((this.removing = !0),
                              s(this.cssSelector.playlist + " li:nth-child(" + (t + 1) + ")").slideUp(this.options.playlistOptions.removeTime, function () {
                                  ...
                                  e.original.length
                                      ? t === e.current
                                          ? ((e.current = t < e.original.length ? e.current : e.original.length - 1), e.select(e.current))
                                          : t < e.current && e.current--
                                      : (s(e.cssSelector.jPlayer).jPlayer("clearMedia"), (e.current = 0), (e.shuffled = !1), e._updateControls()),
                                      (e.removing = !1);
                              })),
                          !0);
            },
            ...
            play: function (t) {
                0 <= (t = t < 0 ? this.original.length + t : t) && t < this.playlist.length
                    ? this.playlist.length && (this.select(t), s(this.cssSelector.jPlayer).jPlayer("play"))
                        ...
                        s(this.cssSelector.playlist + " ul").slideUp(this.options.playlistOptions.shuffleTime, function () {
                            (i.shuffled = t),
                                t
                                    ...
                                    : i._originalPlaylist(),
                                i._refresh(!0),
                                e || !s(i.cssSelector.jPlayer).data("jPlayer").status.paused ? i.play(0) : i.select(0),
