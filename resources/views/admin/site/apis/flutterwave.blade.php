...
@section('content')
                        ...
                        <div class="card-header">
                            ...
                            @else
                                <a href="#" class="btn btn-info btn-round waves-effect waves-light m-1" data-toggle="modal"
                                   data-target="#flutterwaveConfigModal">Configure FlutterWave Payments</a>
                            @endif
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="flutterwaveConfigTable" class="table table-bordered ">
                                    <thead>
    ...
    <!-- Modal -->
    <div class="modal fade flutterwaveConfigModal" id="flutterwaveConfigModal">
        <div class="modal-dialog  modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> Configure FlutterWave Payments</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="fluuterWaveConfig" method="POST" >
                        @csrf
    ...
    <script>
        ...
        var table = $('#flutterwaveConfigTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('flutterWaveConfigIndex')}}",
            columns:[
        ...
        $("#fluuterWaveConfig").on("submit", function (event) {
            event.preventDefault();

            $(".loadingOverlay").fadeIn();
            $.ajax({
                url: "/flutter-wave/config/store",
                method: "POST",
                ...
                success:function(data){
                    ...
                    if (data.success) {
                        ...
                        $('#flutterwaveConfigModal').modal('hide');
                        $('#flutterwaveConfigTable').DataTable().ajax.reload();
