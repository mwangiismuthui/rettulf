                        ...
                        <div class="artist_wrapper_left">
                            <form method="post" id="updateform" enctype="multipart/form-data">
                                ...
                                <div class="login_form_wrapper">
                                    ...
                                    @hasrole ('Producer')
                                    @if($artist->location->location == 'Nigeria')
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-pos">
                                                    <div class="form-group i-name">
                                                        <label for="bank-name">Bank Name</label>
                                                        <select class="form-control require bank-name" id="bank-name"
                                                                name="bank_name" required="">
                                                            <option value="" disabled selected>Select Bank Name *
                                                            </option>
                                                            @foreach ($banks as $bank)
                                                                <option
                                                                    value="{{$bank->bank}}" {{$artist->bank_name==$bank->bank ? 'selected' :''}}>{{$bank->bank}}</option>
                                                            @endforeach
