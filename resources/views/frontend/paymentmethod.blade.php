                        ...
                        <div class="paymentCont">
                            ...
                            <div class="paymentWrap">
                                <div class="method paypal">
                                    <a href={{route('upload_payment',$music->id)}}"><img src="{{asset("frontend/images/paypal-logo.png")}}"></a>
                                </div>
                                <div class="method flutter-wave">
                                    <a href="{{route('initFlutterwavePayments',$music->id)}}"> <img src="{{asset("frontend/images/flutter-logo.png")}}"></a>
                                </div>
                            </div>
