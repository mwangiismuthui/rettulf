                            ...
                            @foreach ($downloaded_musics as $music)
                                ...
                                <ul class="album_inner_list_padding">
                                    <li><a><span class="play_no">0{{$number}}</span><span class="play_hover"> <i
                                                    class="flaticon-play-button"
                                                    id="{{$music->music_id}}"></i></span></a></li>
                                    <li class="text-center">
                                        <div class="top_song_artist_wrapper">
                                            ...
                                            <div class="top_song_artist_contnt">
                                                ...
                                                <p class="various_artist_text"><a href="#">{{$music->description}}</a>
                                                </p>
                                            </div>
                                    ...
                                    <li class="text-center top_song_artist_playlist"><a
                                            href="{{route('downloadPurchasedMusic',$music->music_id)}}"><i
                                                class="flaticon-download"></i></a></li>
                                </ul>
                            @endforeach
                        </div>
                    </div>
